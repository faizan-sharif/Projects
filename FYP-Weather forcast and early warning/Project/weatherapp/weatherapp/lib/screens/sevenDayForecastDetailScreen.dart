...
class SevenDayForecastDetail extends StatefulWidget {
  ...
  const SevenDayForecastDetail({Key? key, this.initialIndex = 0})
    : super(key: key);
...
class _SevenDayForecastDetailState extends State<SevenDayForecastDetail> {
  ...
  void initState() {
    ...
    double _position =
        _selectedIndex * (_itemWidth + 2 * _horizontalPadding) +
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('7-Day Forecast', style: TextStyle(color: Colors.black)),
      ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: isSelected
                              ...
                              : Theme.of(
                                  context,
                                ).scaffoldBackgroundColor.withOpacity(.2),
